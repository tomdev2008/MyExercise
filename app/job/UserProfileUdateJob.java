...
public class UserProfileUdateJob extends Job {
	...
	public UserProfileUdateJob(User u,Subject sb,Tag course,List<UserExercise> ues){
		user = u;
		this.sb =sb;
		this.course = course;
		this.ues = ues;
	...
	public void doJob() throws Exception {
		if(user == null || course == null || sb == null || ues ==null || ues.size() ==0){
			return;
		}
		/**
		 1. 题库信息更新：
		 ...
		 **/
		query = UserExercise.find("user",user).filter("course", course);
